...
mogrify ~/QRCode_Tel_Free_Solutions_Border.png -font helvetica -fill red -pointsize 54 -annotate +80+60 $URLName ~/QRCode_Tel_Free_Solutions_Border.png
...
#timeout 5s xloadimage -fullscreen ~/splash.png & 
#sleep 5 && timeout 20s xloadimage -fullscreen  ~/QRCode_Tel_Free_Solutions.png &
